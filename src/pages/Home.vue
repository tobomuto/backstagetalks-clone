...
export default {
  ...
  mounted() {
    ...
    let sectionTop0 = sectionsTags[0].offsetTop;
    let sectionTop1 = sectionsTags[1].offsetTop;
    let sectionTop2 = sectionsTags[2].offsetTop;
    let sectionTop3 = sectionsTags[3].offsetTop;
    let sectionTop4 = sectionsTags[4].offsetTop;
